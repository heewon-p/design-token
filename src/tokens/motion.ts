...
export const animations = {
  ...
  fadeOut: {
    ...
    `,
    animation: `fadeOut ${motion.duration.normal} ${motion.easing.easeIn}`,
  },
  ...
  scaleIn: {
    ...
    `,
    animation: `scaleIn ${motion.duration.normal} ${motion.easing.easeOut}`,
  },
  ...
  slideUp: {
    ...
    `,
    animation: `slideUp ${motion.duration.normal} ${motion.easing.easeOut}`,
  },
  ...
  slideDown: {
    ...
    `,
    animation: `slideDown ${motion.duration.normal} ${motion.easing.easeOut}`,
  },
